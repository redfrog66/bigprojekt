...
Frontend tesztelést végez: **Kósa Fruzsina** és **Dinó Ákos**
Backend tesztelést végez: **Gellén Rebeka** és **Bukta Ádám**

# Általános leírások a sablonhoz
## Frontend - Felület tesztelési sablon leírás
...
### 6. Teszteredmények:
   ...
   * A backenden létrehozott funkciók megfelelő működésének ellenőrzése a frontend szempontjából (például az változik, és arra, amire kell).
...
## Backend - Háttér tesztelési sablon leírás
